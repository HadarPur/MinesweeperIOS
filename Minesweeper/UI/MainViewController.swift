...
class MainViewController: UIViewController {
    ...
    @IBAction func eazyLevelBtn(_ sender: UIButton) {
        ...
        DispatchQueue.main.asyncAfter(deadline: deadlineTime, execute: { self.navigationController?.pushViewController(self.mGameViewController!, animated: true)
        })
    }
...
//        self.mGameViewController!.mGameBoard.numberOfItems(inSection: 10)
    ...
    @IBAction func recordsBtn(_ sender: UIButton) {
        ...
        DispatchQueue.main.asyncAfter(deadline: deadlineTime, execute: { self.navigationController?.pushViewController(recordsViewController!, animated: true)
        })
    }
    ...
    @IBAction func instructionsBtn(_ sender: UIButton) {
        ...
        DispatchQueue.main.asyncAfter(deadline: deadlineTime, execute: { self.navigationController?.pushViewController(instrucionsViewController!, animated: true)
        })
    }
}
